...
enum regex_grouping {
  ...
  regex_grouping_any_char = regex_token_count + 2,
  regex_grouping_concat = regex_token_count + 3,
  regex_grouping_kleene = regex_token_count + 4,
  regex_grouping_or = regex_token_count + 5,
  regex_grouping_and = regex_token_count + 6,
  regex_grouping_not = regex_token_count + 7,]]
