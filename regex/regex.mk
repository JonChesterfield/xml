...
REGEX_SOURCE := regex.ptree.c regex.tests.c regex.c regex.lexer.definitions.c regex_parser.lemon.c regex_string.c regex_driver.c regex_cache.c regex_equality.c
