...
REGEX_HEADERS := regex/regex.h regex/regex.ptree.h regex/regex.declarations.h tools/ptree.h tools/ptree_impl.h regex/regex.byte_constructors.data regex/regex.ptree.byte_print_array.data regex/regex.lexer.h   regex/regex_string.h
...
$(regex_tmp)/parser_lemon_header_gen: $(regex_tmp)/parser_lemon_header_gen.c $(regex_tmp)/regex.parser_lemon.o
	$(CC) $(CFLAGS) $^ -o $@ -Wl,--unresolved-symbols=ignore-all -static

$(regex_tmp)/parser_bison_header_gen: $(regex_tmp)/parser_bison_header_gen.c $(regex_tmp)/regex.parser_bison.o
	$(CC) $(CFLAGS) $^ -o $@ -Wl,--unresolved-symbols=ignore-all -static


$(regex_tmp)/regex_string.o:	regex/regex.parser_lemon.t
regex/regex.parser_lemon.t:	$(regex_tmp)/parser_lemon_header_gen
	@./$< > $@

regex/regex.parser_bison.t:	$(regex_tmp)/parser_bison_header_gen
	@./$< > $@
