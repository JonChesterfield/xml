...
static inline void contract_active(bool expr,  const char *message, size_t message_length)
{
...
static inline void contract_unit_test(bool expr,  const char *message, size_t message_length)
{
...
static inline void contract_discard(bool expr,  const char *message, size_t message_length)
{
  (void)expr;
  (void)message;
  (void)message_length;
...
static inline void contract_write(bool expr,  const char *message, size_t message_length)
{
  if (!expr)
    {
      int64_t r;
...
static inline void contract_exit(bool expr,  const char *message, size_t message_length)
{
  if (!expr)
    {
...
static inline void contract_longjmp(bool expr,  const char *message, size_t message_length)
{
  ...
  if (!expr)
    {
      ...
      contract_write(false, CONTRACT_SETJMP_ERR_MSG(), sizeof(CONTRACT_SETJMP_ERR_MSG())-1);
      contract_write(expr,  message, message_length);
